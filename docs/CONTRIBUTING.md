...
This project uses [Ralph](RALPH.md) for autonomous development. If you're contributing manually, you can ignore Ralph and follow the standard workflow above.
